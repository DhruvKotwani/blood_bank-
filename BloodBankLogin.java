...
class BloodBankLogin extends JFrame
{
	Container c;
	...
	BloodBankLogin()
	{
		...
		ActionListener a2 = (ae) -> { BloodBankRegister a = new BloodBankRegister(); dispose();};
		btnRegister.addActionListener(a2);
		ActionListener a3 = (ae) -> { BloodBankMenu a = new BloodBankMenu(); dispose();};
		btnLogin.addActionListener(a3);
		
		setTitle("Blood Bank's Login");
		setSize(400,400);
